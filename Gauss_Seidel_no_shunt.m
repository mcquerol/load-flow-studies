...
%  USING THE GAUSS SEIDAL METHOD - NO SHUNT
...
for n = 1:l
    ...
    %  Solving each of the values and replacing the value as soon as it is
    %  calculated
...
title('Convergence of node voltages (per unit) - GAUSS SEIDAL (NO SHUNT CAPACITANCE)');
